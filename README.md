...
* [livekit-elixir-sdk](https://github.com/alexfilatov/livekit-elixir-sdk) - An Elixir SDK for integrating with [LiveKit](https://livekit.io), enabling real-time WebRTC video and audio capabilities.
